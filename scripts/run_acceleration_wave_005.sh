...
output_dir="${project_dir}/pilot/acceleration-wave-005/marker-output"
...
# PDF pages 41-75 are zero-based Marker indexes 40-74. This wave includes
# adjacent boundary context for Batch 009 and all remaining source pages.
