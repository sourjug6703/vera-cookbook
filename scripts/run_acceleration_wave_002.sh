...
output_dir="${project_dir}/pilot/acceleration-wave-002/marker-output"
...
# PDF pages 21-30 are zero-based Marker indexes 20-29. Pages 21 and 30
# provide adjacent layout context around production batch 006 (pages 22-29).
